...
Filter algorithms are **fully based on OBS Studio source code (MIT License)**.
...
Filter algorithms are based on [OBS Studio](https://github.com/obsproject/obs-studio) (MIT License).
